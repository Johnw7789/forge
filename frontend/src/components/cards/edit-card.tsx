import {
  ...
  import { EditCard } from "../../wailsjs/go/main/BackgroundController";
  ...
  export const EditCardModal = ({ card }: EditProps) => {
    ...
    return (
        <Tooltip content="Edit card" color="secondary">
              ...
              {(onClose) => (
                <>
                  ...
                  <ModalFooter>
                    ...
                    <Button color="primary" onPress={() => {editCard(); onClose(); resetState();}}>
                      Edit Card
                    </Button>
                  </ModalFooter>
                </>
